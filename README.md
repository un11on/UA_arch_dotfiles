...
## 🚀 Про систему
Цей репозиторій містить мої персональні налаштування для створення простого та робочого середовища на Arch Linux з Hyprland (Wayland). Все працює для щоденного використання та навчання. Автоматичне встановлення.
